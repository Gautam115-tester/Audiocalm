...
class DownloadModelAdapter extends TypeAdapter<DownloadModel> {
  ...
  DownloadModel read(BinaryReader reader) {
    ...
    return DownloadModel(
      ...
      // FIX: field 14 — nullable so old Hive records without this field
      // deserialise safely (fields[14] will be null if absent).
  ...
  void write(BinaryWriter writer, DownloadModel obj) {
    writer
      ..writeByte(15)       // ← was 14, now 15 fields total
      ..writeByte(0)
      ..write(obj.id)
      ..writeByte(1)
      ..write(obj.mediaId)
